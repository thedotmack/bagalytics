...
interface BagalyticsClientProps {
    ...
    <div className="dark min-h-screen bg-zinc-950 text-white">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <video
          ...
          muted
          playsInline
          className="absolute top-0 left-0 w-screen h-screen object-cover opacity-80"
        >
          <source src="/bagalytics-bg.mp4" type="video/mp4" />
        </video>
        ...
        <header className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
          ...
          <div className="flex items-center justify-between sm:justify-start gap-2 sm:gap-3">
            <div className="flex items-center gap-2 sm:gap-3">
              <Image src="/bagalytics-icon.png" alt="Bagalytics" width={36} height={36} className="sm:w-10 sm:h-10" />
              <h1 className="text-xl sm:text-2xl text-neon" style={{ fontFamily: "var(--font-diplomata)" }}>
                bagalytics
              </h1>
            </div>

            {/* Social links - visible on mobile in header row, hidden on sm+ (moved to right side) */}
            <div className="flex items-center gap-2 sm:hidden">
              <a
                href="https://x.com/Claude_Memory"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center w-10 h-10 text-zinc-500 hover:text-emerald-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 rounded-lg"
                title="Follow on X"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 h-10 px-2 text-zinc-500 hover:text-emerald-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 rounded-lg"
              ...
              >
                ...
                <span className="text-xs font-medium">{githubStars !== null ? (githubStars >= 1000 ? `${(githubStars / 1000).toFixed(1)}k` : githubStars) : "—"}</span>
              </a>
            </div>
          </div>

          {/* Right: Social links + Search (desktop) / Search only (mobile) */}
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
            {/* Social Links - hidden on mobile (shown above), visible on sm+ */}
            <div className="hidden sm:flex items-center gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-1.5 h-10 px-3 text-zinc-500 hover:text-emerald-400 transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 rounded-lg"
                title="Star on GitHub"
                aria-label="Star on GitHub"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex gap-2 w-full sm:w-auto">
              ...
              <Button onClick={analyze} disabled={loading} className="h-9 px-4 text-sm rounded-lg bg-neon-600 hover:bg-neon-500 font-semibold text-black whitespace-nowrap">
                bagalyze
              </Button>
            </div>
          </div>
      ...
      {data && data.hourlyFees && data.hourlyFees.length > 0 && (
        <div
          className="relative z-10 w-full h-64 sm:h-80 outline-none focus:outline-none select-none"
          tabIndex={-1}
          style={{
